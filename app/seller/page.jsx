          ...
          <div className="dashboardHero">
            <div className="dashboardHeroTop">
              <div>
                ...
                <p style={{ margin: 0, color: "var(--amazon-muted)", lineHeight: 1.7, maxWidth: 720 }}>
                  أضف المنتجات، راقب الطلبات، وادِر الشحن والعائدات من مساحة واحدة خفيفة وواضحة
                  ومناسبة للعمل اليومي.
                </p>
              </div>
            ...
            <div className="sellerHeroLayout">
              ...
              <div className="sellerHeroAside">
                ...
                <p>
                  هذه الصفحة مصممة لتجمع ما يحتاجه البائع يوميًا: إدارة المنتج، متابعة الطلبات،
                  والتأكد من أن كل عملية تسليم واضحة.
                </p>
