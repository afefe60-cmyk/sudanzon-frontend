...
const adminActions = [
  {
    title: "إنشاء حساب",
    note: "أضف عميلًا أو بائعًا أو مديرًا من نفس الواجهة.",
  },
  {
    title: "مراجعة طلب",
    note: "راقب الحالة، وعدّلها، واتبع سير الطلبات المفتوحة.",
  },
  {
    title: "إدارة متجر",
...
const adminRoleSummary = [
  ...
  { label: "البائعون", value: "منشأون من الإدارة" },
    ...
    <main className="pageShell">
      ...
      <section className="sectionBlock">
        <div className="container">
          <SectionHeading
            title="لوحة الإدارة"
            subtitle="إحصائيات وإدارة عامة للمنصة من مكان واحد."
          />
