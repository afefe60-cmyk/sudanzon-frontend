...
export default function StoreProfileClient({ initialStore, initialSlug }) {
  ...
  if (!store) {
    return (
      <div className="container szStoreErrorBox">
        ...
        <p>تعذر العثور على هذا المتجر في منصة سودان زون أو أنه قيد المراجعة.</p>
            ...
            <div className="szStoreHeroMain">
              ...
              <div className="szStoreHeroInfo">
                ...
                <p className="szStoreHeroSlug">
                  رابط المتجر: <strong>sudanzon.com/stores/{store.storeSlug || initialSlug}</strong>
                </p>
                ...
                <div className="szStoreMetaBadgesRow">
                  ...
                  <span className="szStoreMetaPill">
                    📦 {store.stats?.productsCount || store.products?.length || 0} منتج متوفر
                  </span>
                  <span className="szStoreMetaPill">
                    ⭐ تقييم 4.9/5 (ممتاز)
                  </span>
